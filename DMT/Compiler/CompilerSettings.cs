...
namespace DMT.Compiler
{
    ...
    {
        public string CompilerVersion = "v3.5";
        ...
        public static CompilerSettings CreatePatchScripts(PatchData data)
        {
            ...
            var dllPaths = Directory.GetFiles(data.ManagedFolder, "*.dll").Where(d => d.EndsWith("/Mods.dll") == false && d.Contains("Assembly-CSharp") == false && d.Contains("mscorlib") == false).ToArray();
